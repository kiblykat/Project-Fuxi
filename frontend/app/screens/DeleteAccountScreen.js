        ...
        <View style={styles.form}>
          ...
          {isValid && (
            <Text style={styles.text}>
              You are attempting to delete your FUXI Music App account. Since
              this account is essential for accessing various features of the
              app, deleting it will result in the loss of access to all
              functionalities. Your account and associated data will be
              permanently deleted.
            </Text>
          )}
