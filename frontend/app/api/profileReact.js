...
export const getReactTrackByProfileId = async (profileId) => {
  try {
    const response = await axios.get(
      `${apiUrl}/dev/profile-react?profileId=${profileId}`
    );
...
export const getLikeTrackByProfileId = async (profileId) => {
  try {
    const response = await axios.get(
      `${apiUrl}/dev/profile-react/like?profileId=${profileId}`
    );
    return response.data;
  } catch (error) {
    console.error('Error:', error);
...
export const getReactTrackByTrackId = async (profileId, trackId) => {
  try {
    const response = await axios.get(
      `${apiUrl}/dev/profile-react/track?profileId=${profileId}&trackId=${trackId}`
    );
    return response.data;
  } catch (error) {
    console.error('Error:', error);
